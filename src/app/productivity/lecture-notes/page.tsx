...
export default function LectureNotes() {
  ...
  const transcribeAudio = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/lecture-notes/transcribe', {
        method: 'POST',
        body: formData,
      });
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-blue-400 transition-colors">
                    ...
                    <p className="text-sm text-gray-500 mb-4">MP3, WAV, M4A 등</p>
                    <input
                      type="file"
                      accept="audio/*"
              ...
              {transcription && (
                <div className="bg-white rounded-2xl shadow-lg p-6">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full py-3 bg-gradient-to-r from-green-500 to-blue-600 text-white font-semibold rounded-xl hover:from-green-600 hover:to-blue-700 transition-all duration-200 disabled:from-gray-300 disabled:to-gray-400 disabled:cursor-not-allowed shadow-lg transform hover:scale-105 disabled:hover:scale-100 flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <div className="flex items-center gap-2">
                        <Loader2 className="w-5 h-5 animate-spin" />
